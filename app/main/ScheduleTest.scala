...
object ScheduleTest extends App {
  ...
  do {
    ...
    val stream2 = new java.io.PrintWriter(new java.io.FileOutputStream("C:\\Phd\\git\\code\\deleteme\\src\\main\\Lin" + size + "_improved.scala"))
    val esc = dsl.codegen.emitSource(dsl.testlin, "testClass", stream2)(dsl.iarg, dsl.iret)
    stream2.flush()
    stream2.close()
